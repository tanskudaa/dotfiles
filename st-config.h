...
static Shortcut shortcuts[] = {
	...
	{ MODKEY,		XK_s,		changealpha,	{.f = -0.25} },
	{ MODKEY,		XK_a,		changealpha,	{.f = +0.25} },
        /*
	{ MODKEY,		XK_s,		setalpha,	{.f =  0.20 } },
	{ MODKEY,		XK_a,		setalpha,	{.f =  0.97 } },
        */
	{ TERMMOD,              XK_Up,          zoom,           {.f = +5} },
	{ TERMMOD,              XK_Down,        zoom,           {.f = -5} },
	{ TERMMOD,              XK_K,           zoom,           {.f = +5} },
	{ TERMMOD,              XK_J,           zoom,           {.f = -5} },
        /*
	{ TERMMOD,              XK_U,           zoom,           {.f = +6} },
	{ TERMMOD,              XK_D,           zoom,           {.f = -6} },
        */
